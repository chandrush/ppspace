package ppspace.geometry.precision.deltathresold;

import ppspace.geometry.precision.IPrecisionConfiguration;

/**
 * Precision configuration based on delta threshold in numbers comparison.
 * @author andrej.chanturidze
 *
 */
public class PrecisionConfiguration implements IPrecisionConfiguration {
